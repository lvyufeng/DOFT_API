...
public class User {
    ...
    public User(Long userId, String userName, String password, String headUrl, String phoneNumber, Long remainingMoney, Integer roleId, Boolean isDeletedFlag, Date creationTime, String createdBy, Date lastUpdatedTime, String lastUpdatedBy, String question, String answer) {
        this.userId = userId;
