    ...
    <div class="form_wrapper">
        <form id="form_login" action="" method="post">
            ...
            <div class="oneform">
                ...
                <div class="form_input">
                    <input type="password" id="pswd1" placeholder="输入密码"/>
                </div>
            </div>
            <div class="oneform">
                <div class="form_label">
            ...
            <div class="oneform">
                ...
                <div id="login" class="form_label">
                    <a href="${ctx}/jsp/login/login.jsp">登录</a>
                </div>
            </div>
...
//            alert("发送失败:"+err);
    ...
    $("#register_btn").click(function () {
        ...
        if (upswd1.length > 20 || upswd1.length < 4) {
            document.getElementById("hint_msg").innerHTML = "密码请输入4-20位字符";
            return false;
        }
        if (upswd1 != upswd2) {
        ...
        if(uname!="" && upswd2!="" && uphone!=""){
            $.ajax({
                ...
                success : function(data) {
                    ...
                    if (data.status == '0'){
                        console.log("ok");
                        window.location.href="http://192.168.1.180:8080/jsp/dishes/dishes.jsp";//js跳转页面
                    }
                    else{
